...
argument-hint: <feature> <prompt-file|--prompt-text "..."> [--rounds N] [--session-policy auto|fresh|resume] [--scope-policy adjudicate|interactive|off] [--read-codebase] [--display-mode inline|tmux] [--force] [--codex-home PATH] [--codex-cmd CMD]
---
...
2. Run either:
   `CROSSAI_CODEX_CMD="..." CODEX_HOME="..." python3 scripts/crossai_cli.py plan --feature "$1" --prompt "$2"`
   or (for inline text):
   `CROSSAI_CODEX_CMD="..." CODEX_HOME="..." python3 scripts/crossai_cli.py plan --feature "$1" --prompt-text "<text>"`
